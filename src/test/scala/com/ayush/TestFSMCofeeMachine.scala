...
import com.ayush.six_FSMBasic.CoffeeMachine
import com.ayush.six_FSMBasic.CoffeeMachine._
import com.ayush.six_FSMBasic.CoffeeProtocol._
import org.scalatest.{MustMatchers, FunSpecLike}

class TestFSMCofeeMachine extends TestKit(ActorSystem("coffee-system")) with MustMatchers with FunSpecLike with ImplicitSender {
